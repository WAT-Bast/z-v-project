...
<head>
    ...
    <link rel="stylesheet" href="/resources/CSS/hospital_information.css">
...
<div class="main_bar_container">
    <div class="main_bar">
        ...
        <form action="" method="post" class="manager_form">
            ...
            <button type="button" class="navyBtn" onClick="location.href=''" type="submit">로그아웃</button>
        </form>
    </div>
</div>
...
<div class="hospital_title">
    <form class="hospital_form_container" method="post" name="manager">
        <div class="hospital_title_name_box">
            <input type="text" type="submit" class="hospital_name_input" value="24시 U&ME 동물병원">
        </div>


        <div class="hospital_img_box">
            <div class="hospital_img_container">
                <img src="/resources/img/24시유앤미동물병원.jpg">
            </div>
        </div>
        ...
        <div class="hospital_information">
            <div class="Address_Box">
                <div class="hospital_address">
                    ...
                    <input class="address_inputBox" type="text" type="submit" placeholder="병원명을 입력해주세요.">
                </div>
            </div>
